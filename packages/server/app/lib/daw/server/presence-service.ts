import { createProjectPresenceSeed, emitDawProjectPresence } from '@/app/lib/daw/server/realtime-gateway';

export type DawProjectPresenceStatus = 'online' | 'idle' | 'away';
export type DawProjectPresenceCurrentTool = 'select' | 'split' | 'merge' | 'fade';
