...
import type { DawVersion } from '@/features/daw/state/daw-state';
import { buildVersionsById, getVersionDisplayLabel } from '@/features/daw/utils/version-labels';
...
export function VersionHistoryTree({
  ...
  return (
    <aside className={`space-y-3 rounded-lg border border-gray-800 bg-gray-900 p-4 ${expanded ? 'lg:col-span-2' : ''}`}>
      ...
      {currentVersion && currentVersion.id !== currentVersionId ? (
