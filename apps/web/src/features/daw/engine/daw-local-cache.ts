import type { DawProjectBootstrapResponse, DawProjectOperationRecord, DawOperationCommitRequest } from '@/features/daw/protocol';
import type { LocalProjectState } from '@/features/daw/state/local-project-state';
import type { LocalProjectSyncOperationStatus } from '@/features/daw/state/local-operation-queue';
